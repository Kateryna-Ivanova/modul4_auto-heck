...
// // За допомогою Object.values виймаємо всі значання ключів з елнмннта players, отримуючи масив значень
// const totalPlayTime = playtimes.reduce((previousValue, number) => {
//   return previousValue + number
// });
// // За допомогою .reduce() сумуємо всі елементи маиву
// const averagePlayTime = totalPlayTime / playtimes.length;
// // playtimes.length- це кількість гравців у масиві playtimes.
// // averagePlayTime обчислює середню кількість годин гри на одного гравця. Вираховуючи суму годин гри ( totalPlayTime) і ділячи її на кількість гравців ( playtimes.length)
...
// {  (player.playtime / player.gamesPlayed) + previousValue  },0
// );
...
//   { title: "Enemy of God", author: "Bernard Cornwell", rating: 8.67 },
// ];
// const sortedByAuthorName = [...books].sort((firstAuthor, secondAutor) => firstAuthor.author.localeCompare(secondAutor.author));

// const sortedByReversedAuthorName = [...books].sort((firstAuthor, secondAutor) => secondAutor.author.localeCompare(firstAuthor.author));

// const sortedByAscendingRating = [...books].sort((firstAuthor, secondAutor) => firstAuthor.rating - secondAutor.rating);

// const sortedByDescentingRating = [...books].sort((firstAuthor, secondAutor) => secondAutor.rating - firstAuthor.rating );
...
// // console.log(books.filter(book => book.rating > MIN_BOOK_RATING).map(book => book.author).sort((a, b) => a.localeCompare(b)))


// TASK 46
// const getNamesSortedByFriendCount = users => {
//  return [...users].sort((a, b) => a.friends.length - b.friends.length).map(a => a.name)
// // console.log([...users].sort((a, b) => a.friends.length - b.friends.length).map(a => a.name))
// };
...
//   // console.log(users.flatMap(user => user.friends).filter((friend, index, array) => array.indexOf(friend) === index).sort((a, b) => a.localeCompare(b)))
...
//   // console.log( users.filter(user => user.gender === gender).reduce((total, user) => total + user.balance, 0))
